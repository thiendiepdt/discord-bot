 ...
 * @example "corona!"
 */
class CoronaInfoCommand extends Command {
	...
	async execute() {
		...
		try {
			...
			browser.close();
			const file = new MessageAttachment('./storage/corona/corona.png');

			const embed = {
				title: 'Corona Info',
				image: {
					url: 'attachment://corona.png',
				},
			};
...
module.exports = CoronaInfoCommand;
